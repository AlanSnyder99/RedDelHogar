...
<div class="container">
    <div class="row">
        ...
        <form method="POST" action="/administrador/guardarSucursal" class="form-horizontal">
            <div class="form-group">
                <h5 for="inputUserName" class="control-label">Descripcion:</h5>
                <input type="text" class="form-control" id="inputUserName" name="descripcion"  required>
                <small id="emailnotification" class="form-text text-muted">Necesario</small>
            </div>
            <div class="form-group">
                <h5 for="inputUserName" class="control-label">Horario:</h5>
                <input type="text" class="form-control" id="inputUserName" name="horario" >
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <input type="text" class="form-control" id="inputUserName" name="telefono">
            </div>
               <div class="form-group">
                <h5 for="inputUserName" class="control-label">Latitud:</h5>
                <input type="text" class="form-control" id="inputUserName" name="latitud">
            </div>
               <div class="form-group">
                <h5 for="inputUserName" class="control-label">Longitud:</h5>
                <input type="text" class="form-control" id="inputUserName" name="longitud">
            </div>
   ...
   while($provincias = mysqli_fetch_assoc($result4)){ 
    ...
    ?>
                    ...
                    <small id="emailnotification" class="form-text text-muted">Necesario</small>
                      ...
                      <div class="form-group">
              <h5 for="comment">Zona:</h5>
               <select class="form-control" name="zona" required>
               <option>---</option>
                 <?php if(mysqli_num_rows($result5) >= 1){
   while($zona = mysqli_fetch_assoc($result5)){ 
    echo " <option>".$zona['idZonas']."-".$zona['zona']."</option>";
...
<div class="container">
 ...
 if(mysqli_num_rows($data) >= 1){
   while($sucursal = mysqli_fetch_assoc($data)){
...
<p><strong>Domicilio:</strong> ".$sucursal['domicilio']." <strong> Tel:</strong> ".$sucursal['telefono']."  </p>
