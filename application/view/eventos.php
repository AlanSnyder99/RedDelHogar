...
<div class="container">
 ...
 if(mysqli_num_rows($data) >= 1){
   while($eventos = mysqli_fetch_assoc($data)){
 
 echo "
          
  <li class='list-group-item'>
<div class='col-md d-flex flex-md-row flex-column align-self-center text-md-left'>
    <img class='rounded mx-left d-block' style='width:25%' src='../application/resources/upload/".$eventos['bannerImg']."' />
    <a href='/main/verEvento?idEventos=".$eventos['idEventos']."' style='text-decoration:none'>
