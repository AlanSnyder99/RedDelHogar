...
<div class='col-md d-flex flex-md-row flex-column align-self-center text-md-left'>
    <img class='rounded mx-left d-block' style='width:25%' src='../application/resources/upload/RespSocial1.jpg' />
    <a href='/main/verResponsabilidad?idResponsabilidades=1' style='text-decoration:none'>
<div class='ccm-block-page-list-page-entry-text' style='margin-left: 10px;'>
  <h3>Donación de Regalos a diferentes Fundaciones</h3>
    <h5>Enero 2018    </h5>
<p>Colaboramos Garrahan, DGNyA y Club de Leones.</p>
</div>
</a>
  </li>
<br>
  ...
  <li class='list-group-item'>
<div class='col-md d-flex flex-md-row flex-column align-self-center text-md-left'>
    <img class='rounded mx-left d-block' style='width:25%' src='../application/resources/upload/RespSocial2.jpg' />
    <a href='/main/verResponsabilidad?idResponsabilidades=2' style='text-decoration:none'>
<div class='ccm-block-page-list-page-entry-text' style='margin-left: 10px;'>
  <h3>Doná tapitas, destapá sonrisas – Programa de recolección.</h3>
    <h5>Enero 2020</h5>
<p>Las tapitas se convierten en fondos para ayudar a la Fundación Garrahan</p>
</div>
</a>
  </li>
<br>
